  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to DEV Token Presale!</h1>
          <div className={styles.description}>
            Participate Now!!!
          </div>
          {walletConnected ? (
            <div>
              <div className={styles.description}>
                ...
                You have bought {utils.formatEther(balanceOfCryptoDevTokens)} 
                 Tokens
              </div>
              <div className={styles.description}>
                {/* Format Ether helps us in converting a BigNumber to string */}
                Overall {utils.formatEther(tokensMinted)}/10000 have been Bought!!!
              </div>
              {renderButton()}
            </div>
          ) : (
